...
public class Book implements Serializable {
    ...
    private boolean isGroupCollaboration;
    private Map<String, CollaborationType> collaborations; // New field to track collaboration types
    ...
    public boolean isGroupCollaboration() {
        return isGroupCollaboration;
    }
    ...
    public void setGroupCollaboration(boolean groupCollaboration) {
        isGroupCollaboration = groupCollaboration;
    }
